export const MouseButtonMain = 0; // left
export const MouseButtonAux = 1; // middle
...
export const selectionDistance = 3;

export const hoverThreshold = 10;
export const hoverWidth = 2;
export const hoverStrokeStyle = 'yellow';
export const hoverDistance = 6;
export const hoverDash = [3, 3];
